...
Router.get(ROUTES.EDITAR_IMAGEN_ANUNCIO, /* authMiddleware.verificarUsuarioAutenticado, */ anuncioController.mostrarPaginaEditarAnuncio);
Router.post(ROUTES.EDITAR_IMAGEN_ANUNCIO, /* authMiddleware.verificarUsuarioAutenticado, */ anuncioController.subirImagen, anuncioController.editarAnuncio);
